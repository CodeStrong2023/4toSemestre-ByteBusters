...
from clase01.clase01.capa_datos_persona.cursor_del_pool import CursorDelPool
...
if __name__ == '__main__':
    ...
    # Insertar usuario
    usuario = Usuario(username='', password='369')
    usuario_insertado = UsuarioDAO.insertar(usuario)
    log.debug(f'Usuario modificado: {usuario_insertado}')

    # Listar o seleccionar
    usuarios = UsuarioDAO.seleccionar()
    usuario_modificado = UsuarioDAO.insertar(usuario)
    log.debug(f'Usuario modificado: {usuario_modificado}')
